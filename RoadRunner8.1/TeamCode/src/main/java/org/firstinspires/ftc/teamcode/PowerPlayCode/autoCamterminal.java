 ...
 * is explained below.
 */
@Autonomous(name = "autoterminal", group = "LinearOpMode")

public class autoCamterminal extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       drive.clawwwOpen();
        ...
        waitForStart();
        drive.PrecisionDriveForwardReverse(0.8, 10);
        sleep(4000);
        drive.PrecisionDriveForwardReverse(-0.8, 5);
        sleep(4000);
