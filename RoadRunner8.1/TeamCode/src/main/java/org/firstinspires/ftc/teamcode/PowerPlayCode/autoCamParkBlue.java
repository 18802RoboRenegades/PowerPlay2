 ...
 * is explained below.
 */
@Autonomous(name = "autoBlueCorner", group = "LinearOpMode")

public class autoCamParkBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        sleep(1500);
        drive.PrecisionDriveForwardReverse(0.3, 4);
        sleep(500);
        drive.PrecisionStrafe(0.3, 9);
        sleep(500);
        drive.clawwwOpen();
        sleep(500);
        drive.PrecisionStrafe(-0.3, -9);
        sleep(1000);
        drive.PrecisionDriveForwardReverse(0.3, 20);
        sleep(500);
        if (position == 1) {
            drive.PrecisionStrafe(0.3, 14);
        } else if (position == 3) {
            drive.PrecisionStrafe(-0.3, -14);
        }
